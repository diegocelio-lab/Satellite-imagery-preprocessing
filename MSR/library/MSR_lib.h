...
double *convolution_masked(double *input, uint8_t *nodata, double scale, double *output, size_t nx, size_t ny);

double *MSRetinex(double *out, double *input, uint8_t *nodata, double *scale, int nscales, double w, size_t nx, size_t ny);
