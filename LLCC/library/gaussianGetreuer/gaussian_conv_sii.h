...
void sii_gaussian_conv(const sii_coeffs c, float *dest, float *buffer,
    const float *src, const uint8_t *nodata, long N, long stride);
void sii_gaussian_conv_image(const sii_coeffs c, float *dest, float *buffer,
    const float *src, const uint8_t *nodata, int width, int height, int num_channels);
